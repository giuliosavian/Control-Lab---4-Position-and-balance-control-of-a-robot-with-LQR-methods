 ...
 *
 * File: robust_drift_REALTIME_types.h
 *
...
#ifndef RTW_HEADER_robust_drift_REALTIME_types_h_
#define RTW_HEADER_robust_drift_REALTIME_types_h_
#include "rtwtypes.h"
...
typedef struct P_Monostable_robust_drift_REA_T_ P_Monostable_robust_drift_REA_T;

/* Parameters for system: '<Root>/Up-Counter (with upper bound)' */
typedef struct P_UpCounterwithupperbound_rob_T_ P_UpCounterwithupperbound_rob_T;

/* Parameters (default storage) */
typedef struct P_robust_drift_REALTIME_T_ P_robust_drift_REALTIME_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_robust_drift_REALTIME_T RT_MODEL_robust_drift_REALTIM_T;

#endif                           /* RTW_HEADER_robust_drift_REALTIME_types_h_ */
