 ...
 *
 * File: robust_REALTIME_private.h
 *
...
#ifndef RTW_HEADER_robust_REALTIME_private_h_
#define RTW_HEADER_robust_REALTIME_private_h_
#include "rtwtypes.h"
...
extern void robust_REALTIME_Monostable_Init(boolean_T *rty_Out,
  DW_Monostable_robust_REALTIME_T *localDW, P_Monostable_robust_REALTIME_T
  *localP);
extern void robust_REALTIM_Monostable_Reset(DW_Monostable_robust_REALTIME_T
  *localDW, P_Monostable_robust_REALTIME_T *localP);
extern void robust_REALT_Monostable_Disable(DW_Monostable_robust_REALTIME_T
  *localDW);
extern void robust_REALTIME_Monostable(real_T rtu_Enable, boolean_T *rty_Out,
  DW_Monostable_robust_REALTIME_T *localDW, P_Monostable_robust_REALTIME_T
...
#endif                               /* RTW_HEADER_robust_REALTIME_private_h_ */
