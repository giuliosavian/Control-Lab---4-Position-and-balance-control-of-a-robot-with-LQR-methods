...
#ifndef RTW_HEADER_robust_REALTIME_h_
#define RTW_HEADER_robust_REALTIME_h_
#include <math.h>
#include <stddef.h>
#ifndef robust_REALTIME_COMMON_INCLUDES_
#define robust_REALTIME_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#endif                                 /* robust_REALTIME_COMMON_INCLUDES_ */

#include "robust_REALTIME_types.h"
...
} DW_Monostable_robust_REALTIME_T;
...
typedef struct {
  ...
  int16_T SFunction_o1_j[3];           /* '<S16>/S-Function' */
  int16_T SFunction_o2_g[3];           /* '<S16>/S-Function' */
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator_DSTATE_h;/* '<S9>/Discrete-Time Integrator' */
  void* SFunction_DWORK1[2];           /* '<S10>/S-Function' */
  boolean_T SFunction_DWORK2;          /* '<S10>/S-Function' */
  boolean_T SScontrollerrobust1_MODE;  /* '<Root>/SS controller robust1' */
  boolean_T Referencegenerator1_MODE;  /* '<Root>/Reference generator1' */
  boolean_T Referencegenerator_MODE;   /* '<Root>/Reference generator' */
  ...
  DW_UpCounterwithupperbound_ro_T UpCounterwithupperbound;
                                    /* '<Root>/Up-Counter (with upper bound)' */
  DW_Monostable_robust_REALTIME_T Monostable1;/* '<Root>/Monostable1' */
  DW_Monostable_robust_REALTIME_T Monostable;/* '<Root>/Monostable' */
} DW_robust_REALTIME_T;
...
typedef struct {
  ...
  ZCE_UpCounterwithupperbound_r_T UpCounterwithupperbound;
                                    /* '<Root>/Up-Counter (with upper bound)' */
} PrevZCX_robust_REALTIME_T;

/* Parameters for system: '<Root>/Monostable' */
struct P_Monostable_robust_REALTIME_T_ {
...
struct P_robust_REALTIME_T_ {
  ...
  P_UpCounterwithupperbound_rob_T UpCounterwithupperbound;
                                    /* '<Root>/Up-Counter (with upper bound)' */
  P_Monostable_robust_REALTIME_T Monostable1;/* '<Root>/Monostable1' */
  P_Monostable_robust_REALTIME_T Monostable;/* '<Root>/Monostable' */
};

/* Real-time Model Data Structure */
struct tag_RTM_robust_REALTIME_T {
  const char_T *errorStatus;
};

/* Block parameters (default storage) */
extern P_robust_REALTIME_T robust_REALTIME_P;

/* Block signals (default storage) */
extern B_robust_REALTIME_T robust_REALTIME_B;

/* Block states (default storage) */
extern DW_robust_REALTIME_T robust_REALTIME_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_robust_REALTIME_T robust_REALTIME_PrevZCX;

/* Model entry point functions */
extern void robust_REALTIME_initialize(void);
extern void robust_REALTIME_step(void);
extern void robust_REALTIME_terminate(void);

/* Real-time Model object */
extern RT_MODEL_robust_REALTIME_T *const robust_REALTIME_M;
 ...
 *
 * '<Root>' : 'robust_REALTIME'
 * '<S1>'   : 'robust_REALTIME/Encoders'
 * '<S2>'   : 'robust_REALTIME/MPU6050 Inertial Measurement Unit'
 * '<S3>'   : 'robust_REALTIME/Monostable'
 * '<S4>'   : 'robust_REALTIME/Monostable1'
 * '<S5>'   : 'robust_REALTIME/Motors'
 * '<S6>'   : 'robust_REALTIME/Pushbuttons'
 * '<S7>'   : 'robust_REALTIME/Reference generator'
 * '<S8>'   : 'robust_REALTIME/Reference generator1'
 * '<S9>'   : 'robust_REALTIME/SS controller robust1'
 * '<S10>'  : 'robust_REALTIME/Serial Packet Send'
 * '<S11>'  : 'robust_REALTIME/State Observer'
 * '<S12>'  : 'robust_REALTIME/Up-Counter (with upper bound)'
 * '<S13>'  : 'robust_REALTIME/Up-Counter (with upper bound)1'
 * '<S14>'  : 'robust_REALTIME/Encoders/Encoders'
 * '<S15>'  : 'robust_REALTIME/Encoders/To Wheel Frames'
 * '<S16>'  : 'robust_REALTIME/MPU6050 Inertial Measurement Unit/MPU'
 * '<S17>'  : 'robust_REALTIME/MPU6050 Inertial Measurement Unit/Raw to physical units'
 * '<S18>'  : 'robust_REALTIME/MPU6050 Inertial Measurement Unit/To Body Frame'
 * '<S19>'  : 'robust_REALTIME/Monostable/Compare To Constant'
 * '<S20>'  : 'robust_REALTIME/Monostable1/Compare To Constant'
 * '<S21>'  : 'robust_REALTIME/Motors/From Wheel Frames'
 * '<S22>'  : 'robust_REALTIME/Motors/Motors'
 * '<S23>'  : 'robust_REALTIME/State Observer/Complementary filter'
 */
#endif                                 /* RTW_HEADER_robust_REALTIME_h_ */
